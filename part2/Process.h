...
public:
    Process() : id(0), is_cpu_bound(0), arrival_time(0), cpu_burst_count(0), status(""), tau(0), current_burst_index(0), remaining_burst_time(0) {}
    Process(char id, int is_cpu_bound, int arrival_time, int cpu_burst_count, std::vector<int> cpu_bursts, std::vector<int> io_bursts) : id(id), is_cpu_bound(is_cpu_bound), arrival_time(arrival_time), cpu_burst_count(cpu_burst_count), cpu_bursts(cpu_bursts), io_bursts(io_bursts), status(""), tau(0), current_burst_index(0), remaining_burst_time(0) {}
